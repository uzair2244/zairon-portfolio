  ...
  const features = [
    {
      ...
      description: "We leverage cutting-edge technologies and modern development practices to deliver solutions that are ahead of the curve."
    },
    {
      icon: Shield,
      title: "Security Focused",
      description: "Every solution is built with security at its core, implementing industry best practices and robust protection measures."
    },
    {
      icon: Code2,
      title: "Clean Code",
      description: "Our development process emphasizes clean, maintainable code that scales with your business needs and future requirements."
    },
    {
      icon: Users,
      title: "Collaborative Approach",
      description: "We work closely with our clients, ensuring transparent communication and alignment throughout the development process."
    },
    {
      icon: Zap,
      title: "Performance Optimized",
      description: "Every solution is fine-tuned for optimal performance, ensuring fast load times and smooth user experiences."
    },
    {
      icon: Clock,
      title: "Timely Delivery",
      description: "We understand the importance of time-to-market and consistently deliver projects within agreed timelines."
    }
  ];
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <p className="text-lg text-white/70">
            We combine technical expertise with creative problem-solving to deliver exceptional digital solutions that drive real business value.
          </p>
        </div>
        ...
        <div className="mt-20 text-center">
          ...
          <div className="mt-6">
            <button className="px-8 py-4 rounded-xl bg-gradient-to-r from-cyan-500 to-purple-500 text-white font-semibold hover:scale-105 transition-transform duration-300">
              Get in Touch
            </button>
          </div>
        </div>
